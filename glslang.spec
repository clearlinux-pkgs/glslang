...
Version  : 15.3.0
Release  : 58
URL      : https://github.com/KhronosGroup/glslang/archive/15.3.0/glslang-15.3.0.tar.gz
Source0  : https://github.com/KhronosGroup/glslang/archive/15.3.0/glslang-15.3.0.tar.gz
...
%prep
%setup -q -n glslang-15.3.0
cd %{_builddir}/glslang-15.3.0
pushd ..
cp -a glslang-15.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746127411
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSPIRV.so.15.3.0
/V3/usr/lib64/libSPVRemapper.so.15.3.0
/V3/usr/lib64/libglslang-default-resource-limits.so.15.3.0
/V3/usr/lib64/libglslang.so.15.3.0
/usr/lib64/libSPIRV.so
/usr/lib64/libSPIRV.so.15
/usr/lib64/libSPIRV.so.15.3.0
/usr/lib64/libSPVRemapper.so
/usr/lib64/libSPVRemapper.so.15
/usr/lib64/libSPVRemapper.so.15.3.0
/usr/lib64/libglslang-default-resource-limits.so
/usr/lib64/libglslang-default-resource-limits.so.15
/usr/lib64/libglslang-default-resource-limits.so.15.3.0
/usr/lib64/libglslang.so
/usr/lib64/libglslang.so.15
/usr/lib64/libglslang.so.15.3.0
