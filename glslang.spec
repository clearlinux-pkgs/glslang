...
Source0  : https://github.com/KhronosGroup/glslang/archive/7.11.3188/glslang-7.11.3188.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557390961
mkdir -p clr-build
pushd clr-build
