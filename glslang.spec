...
Version  : 7.8.2850
Release  : 8
URL      : https://github.com/KhronosGroup/glslang/archive/7.8.2850.tar.gz
Source0  : https://github.com/KhronosGroup/glslang/archive/7.8.2850.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533919843
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
