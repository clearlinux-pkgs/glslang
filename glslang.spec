...
%prep
%setup -q -n glslang-15.0.0
cd %{_builddir}/glslang-15.0.0
pushd ..
cp -a glslang-15.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727422453
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSPIRV.so.15.0.0
/V3/usr/lib64/libSPVRemapper.so.15.0.0
/V3/usr/lib64/libglslang-default-resource-limits.so.15.0.0
/V3/usr/lib64/libglslang.so.15.0.0
