...
Version  : 14.1.0
Release  : 51
URL      : https://github.com/KhronosGroup/glslang/archive/14.1.0/glslang-14.1.0.tar.gz
Source0  : https://github.com/KhronosGroup/glslang/archive/14.1.0/glslang-14.1.0.tar.gz
...
%prep
%setup -q -n glslang-14.1.0
cd %{_builddir}/glslang-14.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710167175
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSPIRV.so.14.1.0
/V3/usr/lib64/libSPVRemapper.so.14.1.0
/V3/usr/lib64/libglslang-default-resource-limits.so.14.1.0
/V3/usr/lib64/libglslang.so.14.1.0
/usr/lib64/libSPIRV.so
/usr/lib64/libSPIRV.so.14
/usr/lib64/libSPIRV.so.14.1.0
/usr/lib64/libSPVRemapper.so
/usr/lib64/libSPVRemapper.so.14
/usr/lib64/libSPVRemapper.so.14.1.0
/usr/lib64/libglslang-default-resource-limits.so
/usr/lib64/libglslang-default-resource-limits.so.14
/usr/lib64/libglslang-default-resource-limits.so.14.1.0
/usr/lib64/libglslang.so
/usr/lib64/libglslang.so.14
/usr/lib64/libglslang.so.14.1.0
